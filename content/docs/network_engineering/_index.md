...
{{< cards cols="2">}}
  ...
  {{< card link="part_7/" title="7. Inventory" subtitle="This part explains how I turn my Ansible inventory from a simple connectivity file into a structured source of truth that defines device groups, platform-specific connection settings, and realistic per-device data for the lab." >}}
  {{< card link="" title="8. Structure" subtitle="Work in progress." >}}

  {{< card link="" title="9. Adhoc" subtitle="Work in progress." >}}
  {{< card link="" title="10. Playbooks" subtitle="Work in progress." >}}

  {{< card link="" title="11. Jinja2" subtitle="Work in progress." >}}
  {{< card link="" title="12. Ansible Vault" subtitle="Work in progress." >}}

  {{< card link="" title="13. Roles" subtitle="Work in progress." >}}
  {{< card link="" title="14. Tags" subtitle="Work in progress." >}}

  {{< card link="" title="15. Error Handling" subtitle="Work in progress." >}}
  {{< card link="" title="16. Paramiko" subtitle="Work in progress." >}}

  {{< card link="" title="17. IOS for CCNA" subtitle="Work in progress." >}}
  {{< card link="" title="18. IOS for CCNP" subtitle="Work in progress." >}}

  {{< card link="" title="19. NXOS" subtitle="Work in progress." >}}
  {{< card link="" title="20. JunOS" subtitle="Work in progress." >}}

  {{< card link="" title="21. PanOS" subtitle="Work in progress." >}}
  {{< card link="" title="22. Validation" subtitle="Work in progress." >}}

  {{< card link="" title="23. Maintenance" subtitle="Work in progress." >}}
  {{< card link="" title="24. Uninstall" subtitle="Work in progress." >}}

  {{< card link="" title="25. Users & AAA" subtitle="Work in progress." >}}
  {{< card link="" title="26. Netbox" subtitle="Work in progress." >}}

  {{< card link="" title="27. Cron" subtitle="Work in progress." >}}
  {{< card link="" title="28. AWX" subtitle="Work in progress." >}}

  {{< card link="" title="29. Advanced Techniques" subtitle="Work in progress." >}}
  {{< card link="" title="30. Backup & Restore" subtitle="Work in progress." >}}

  {{< card link="" title="31. Collections" subtitle="Work in progress." >}}
  {{< card link="" title="32. Testing CI/CD" subtitle="Work in progress." >}}
{{< /cards >}}